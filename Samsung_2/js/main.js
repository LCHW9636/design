$(document).ready(function(){
    ...
    function scroll_chk(){ //함수의 선언 
        ...
        if(scrolling > 0){ //스크롤 된 값이 0 보다 크다면 - fixed클래스 추가
            $('.header').addClass('fixed')
        }else{ // 0이거나 0보다 작거나 - fixed클래스 삭제 
    ...
    /*
        ...
        1차메뉴 a를 클릭하며 감싸는 li에 클래스를 추가
        a는 href 이동값을 가지고있음 이게 모바일에서 클릭되면 xxxx
    */
